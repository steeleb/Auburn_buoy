...
L1_2015 <- L1_2015 %>% 
  mutate_at(vars(therm),
            funs(case_when(datetime_instrument<as.POSIXct('2015-05-07 10:10', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .)))
...
# ggplot(subset(buoy_therm_vert_L1_b, subset=(datetime_instrument>=as.POSIXct('2015-05-01', tz='Etc/GMT+4') & 
#                                             datetime_instrument<as.POSIXct('2015-06-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=variable)) +
#   geom_point() +
...
#                               "#f5ee89", "#005180", "#0081cc"))
# 
# ggplot(subset(buoy_therm_vert_L1, subset=(datetime_instrument>=as.POSIXct('2015-06-01', tz='Etc/GMT+4') & 
...
L1_2015 <- L1_2015 %>% 
  mutate_at(vars(therm),
            funs(case_when(datetime_instrument==as.POSIXct('2015-06-18 10:30', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .)))
buoy_therm_vert_L1_b <- L1_2015 %>% 
  select(datetime_instrument, therm) %>% 
  gather(variable, value, -datetime_instrument) %>% 
...
# ggplot(subset(buoy_therm_vert_L1_b, subset=(datetime_instrument>=as.POSIXct('2015-06-01', tz='Etc/GMT+4') & 
#                                             datetime_instrument<as.POSIXct('2015-07-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=variable)) +
#   geom_point() +
...
L1_2015 <- L1_2015 %>% 
  mutate_at(vars(therm),
            funs(case_when(datetime_instrument>=as.POSIXct('2015-07-02 9:20', tz='Etc/GMT+4')  &
                             datetime_instrument<as.POSIXct('2015-07-02 10:00', tz='Etc/GMT+4')~ NA_real_,
                           TRUE ~ .))) %>% 
  mutate_at(vars(therm),
            funs(case_when(datetime_instrument==as.POSIXct('2015-07-16 10:20', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .))) %>% 
  mutate_at(vars(therm),
            funs(case_when(datetime_instrument>=as.POSIXct('2015-07-23 10:30', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-23 10:50', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .))) %>% 
  mutate_at(vars(therm),
            funs(case_when(datetime_instrument>=as.POSIXct('2015-07-30 8:50', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-30 10:10', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .)))
buoy_therm_vert_L1_b <- L1_2015 %>% 
  select(datetime_instrument, therm) %>% 
  gather(variable, value, -datetime_instrument) %>% 
...
# ggplot(subset(buoy_therm_vert_L1_b, subset=(datetime_instrument>=as.POSIXct('2015-07-01', tz='Etc/GMT+4') & 
#                                             datetime_instrument<as.POSIXct('2015-08-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=variable)) +
#   geom_point() +
...
#                               "#f5ee89", "#005180", "#0081cc"))
# 
# ggplot(subset(buoy_therm_vert_L1, subset=(datetime_instrument>=as.POSIXct('2015-08-01', tz='Etc/GMT+4') & 
...
#                               "#f5ee89", "#005180", "#0081cc"))
# 
# ggplot(subset(buoy_therm_vert_L1, subset=(datetime_instrument>=as.POSIXct('2015-09-01', tz='Etc/GMT+4') & 
#                                             datetime_instrument<as.POSIXct('2015-10-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=variable)) +
#   geom_point() +
...
#                               "#f5ee89", "#005180", "#0081cc"))
# 
# ggplot(subset(buoy_therm_vert_L1, subset=(datetime_instrument>=as.POSIXct('2015-10-01', tz='Etc/GMT+4') & 
#                                             datetime_instrument<as.POSIXct('2015-11-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=variable)) +
#   geom_point() +
...
L1_2015 <- L1_2015 %>% 
  mutate_at(vars(therm),
            funs(case_when(datetime_instrument>=as.POSIXct('2015-11-18 8:00', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .)))
buoy_therm_vert_L1_b <- L1_2015 %>% 
  select(datetime_instrument, therm) %>% 
  gather(variable, value, -datetime_instrument) %>% 
...
# ggplot(subset(buoy_therm_vert_L1_b, subset=(datetime_instrument>=as.POSIXct('2015-11-01', tz='Etc/GMT+4') & 
#                                             datetime_instrument<as.POSIXct('2015-12-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=variable)) +
#   geom_point() +
...
# 
# ggplot(subset(buoy_do_vert_L1, subset=(datetime_instrument >=as.POSIXct('2015-05-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-06-01', tz='Etc/GMT+4'))),
...
L1_2015 <- L1_2015 %>% 
  ...
  mutate_at(vars(do_ppm_1m, do_ppm_14.5m, do_ppm_32m, do_sat_pct_1m, do_sat_pct_14.5m, do_sat_pct_32m),
            funs(case_when(datetime_instrument<as.POSIXct('2015-05-07 14:00', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .)))
...
# ggplot(subset(buoy_do_vert_L1_b, subset=(datetime_instrument >=as.POSIXct('2015-05-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-06-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=as.factor(depth))) +
#   geom_point() +
#   facet_grid(sensor ~ ., scales='free_y') +
...
L1_2015 <- L1_2015 %>% 
  mutate_at(vars(dotemp_C_1m, dotemp_C_14.5m, do_ppm_1m, do_ppm_14.5m, do_sat_pct_1m, do_sat_pct_14.5m),
            funs(case_when(datetime_instrument==as.POSIXct('2015-06-04 10:10', tz='Etc/GMT+4') ~ NA_real_,
                           datetime_instrument>=as.POSIXct('2015-06-18 10:30', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-06-18 10:50', tz='Etc/GMT+4') ~ NA_real_,
                           datetime_instrument==as.POSIXct('2015-06-25 9:10', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .))) 
...
# ggplot(subset(buoy_do_vert_L1_b, subset=(datetime_instrument >=as.POSIXct('2015-06-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-07-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=as.factor(depth))) +
#   geom_point() +
#   facet_grid(sensor ~ ., scales='free_y') +
...
L1_2015 <- L1_2015 %>% 
  mutate_at(vars(dotemp_C_1m, do_ppm_1m, do_sat_pct_1m, dotemp_C_14.5m, do_ppm_14.5m, do_sat_pct_14.5m),
            funs(case_when(datetime_instrument>=as.POSIXct('2015-07-02 8:20', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-02 9:20', tz='Etc/GMT+4') ~ NA_real_,
                           datetime_instrument>=as.POSIXct('2015-07-30 8:50', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-30 10:00', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .))) %>% 
  mutate_at(vars(dotemp_C_32m, do_ppm_32m, do_sat_pct_32m),
            funs(case_when(datetime_instrument>=as.POSIXct('2015-07-02 9:20', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-02 9:50', tz='Etc/GMT+4') ~ NA_real_,
                           datetime_instrument>=as.POSIXct('2015-07-30 9:00', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-30 10:00', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .))) %>% 
  mutate_at(vars(do_ppm_1m, do_sat_pct_1m, do_ppm_14.5m, do_sat_pct_14.5m),
            funs(case_when(datetime_instrument>=as.POSIXct('2015-07-02', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-02', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .))) %>%
  mutate_at(vars(do_ppm_1m, do_sat_pct_1m, do_ppm_14.5m, do_sat_pct_14.5m, do_ppm_32m, do_sat_pct_32m),
            funs(case_when(datetime_instrument>=as.POSIXct('2015-07-02 9:20', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-02 13:50', tz='Etc/GMT+4') ~ NA_real_,
                           datetime_instrument>=as.POSIXct('2015-07-30 10:00', tz='Etc/GMT+4') &
                             datetime_instrument<as.POSIXct('2015-07-30 14:00', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .))) 
buoy_do_vert_L1_b <- L1_2015 %>% 
  select(datetime_instrument, do) %>% 
  gather(variable, value, -datetime_instrument) %>% 
...
# ggplot(subset(buoy_do_vert_L1_b, subset=(datetime_instrument >=as.POSIXct('2015-07-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-08-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=as.factor(depth))) +
#   geom_point() +
#   facet_grid(sensor ~ ., scales='free_y') +
...
L1_2015 <- L1_2015 %>% 
  mutate_at(vars(dotemp_C_1m, do_ppm_1m, do_sat_pct_1m, dotemp_C_14.5m, do_ppm_14.5m, do_sat_pct_14.5m),
            funs(case_when(datetime_instrument==as.POSIXct('2015-08-28 12:00', tz='Etc/GMT+4') ~ NA_real_,
                           TRUE ~ .))) 
buoy_do_vert_L1_b <- L1_2015 %>% 
  select(datetime_instrument, do) %>% 
  gather(variable, value, -datetime_instrument) %>% 
...
# ggplot(subset(buoy_do_vert_L1_b, subset=(datetime_instrument >=as.POSIXct('2015-08-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-09-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=as.factor(depth))) +
#   geom_point() +
#   facet_grid(sensor ~ ., scales='free_y') +
...
#   scale_color_colorblind()
# 
# ggplot(subset(buoy_do_vert_L1, subset=(datetime_instrument >=as.POSIXct('2015-09-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-10-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=as.factor(depth))) +
#   geom_point() +
#   facet_grid(sensor ~ ., scales='free_y') +
...
#   scale_color_colorblind()
# 
# ggplot(subset(buoy_do_vert_L1, subset=(datetime_instrument >=as.POSIXct('2015-10-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-11-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=as.factor(depth))) +
#   geom_point() +
#   facet_grid(sensor ~ ., scales='free_y') +
...
#   scale_color_colorblind()
# 
# ggplot(subset(buoy_do_vert_L1, subset=(datetime_instrument >=as.POSIXct('2015-11-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-12-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=as.factor(depth))) +
#   geom_point() +
#   facet_grid(sensor ~ ., scales='free_y') +
...
# ggplot(subset(buoy_do_vert_L1_b, subset=(datetime_instrument >=as.POSIXct('2015-11-01', tz='Etc/GMT+4') &
#                                          datetime_instrument < as.POSIXct('2015-12-01', tz='Etc/GMT+4'))),
#        aes(x=datetime_instrument, y=value, color=as.factor(depth))) +
#   geom_point() +
#   facet_grid(sensor ~ ., scales='free_y') +
